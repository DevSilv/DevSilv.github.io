...
[**Update 2018 nov 29**] This article has contained description of the grammar, orthography and writing style that I use in my articles in general.
...
these are not all the rules that i try to follow. the other part is earlier described by me here: <https://devsilv.github.io/2018/07/10/tips-for-blogging-developers.html>
...
- [a subset of mine – dedicated to everybody, not just myself](https://devsilv.github.io/2018/07/10/tips-for-blogging-developers.html)
